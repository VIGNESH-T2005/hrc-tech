...
{
    /// <inheritdoc />
    public partial class AddEnrollmentsProgressAndContentTokens : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ContentAccessTokens",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContentAccessTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContentAccessTokens_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContentAccessTokens_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentAccessTokens_LessonId_ExpiresAt",
                table: "ContentAccessTokens",
                columns: new[] { "LessonId", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ContentAccessTokens_StudentId",
                table: "ContentAccessTokens",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_ContentAccessTokens_TokenHash",
                table: "ContentAccessTokens",
                column: "TokenHash",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonProgress_StudentId_CourseId",
                table: "LessonProgress",
                columns: new[] { "StudentId", "CourseId" });
